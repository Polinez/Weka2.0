...
if not SECRET_KEY:
    raise ValueError(
        "Not found SECRET or SECRET_KEY environment variable. Please set it in Azure App Settings."
    )
...
if not connection_string:
    raise ValueError(
        "AZURE_POSTGRESQL_CONNECTIONSTRING environment variable is not set or empty."
    )
